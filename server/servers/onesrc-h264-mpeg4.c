...
#define DEFAULT_PROFILE_FILE_VIDEO_H264_MPEG4   "onesrc-h264-mpeg4.ini"
...
main (int argc, char *argv[])
{
  ...
  profile_video = gst_rtsp_pipeline_profile_load(DEFAULT_PROFILE_FILE_VIDEO_H264_MPEG4);
  ...
  /* attach the test factory to the /h264-mp4 url */
  gst_rtsp_media_mapping_add_factory (mapping, "/h264-mp4", factory);
