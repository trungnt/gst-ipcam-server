...
#define DEFAULT_PROFILE_FILE_VIDEO_JPEG_MPEG4   "onesrc-jpeg-mpeg4.ini"
...
main (int argc, char *argv[])
{
  ...
  profile_video = gst_rtsp_pipeline_profile_load(DEFAULT_PROFILE_FILE_VIDEO_JPEG_MPEG4);
  ...
  /* attach the test factory to the /jpg-mp4 url */
  gst_rtsp_media_mapping_add_factory (mapping, "/jpg-mp4", factory);
