...
/**
 * Set server configuration for the media factory.
 * Pipeline will be generated by using server configuration.
 *
 * @param factory GstRTSPMediaFactory* media factory to use
 * @param server_config GstRTSPServerConfiguration* server configuration to set
 *
 * @return None
 */
void
...
/**
 * Get current server configuration of the media factory.
 *
 * @param factory GstRTSPMediaFactory* media factory to get
 *
 * @return GstRTSPServerConfiguration* current server configuration of the factory or NULL if no one is set
 */
